          ...
          <CardContent>
            <Tabs defaultValue="login">
              ...
              <TabsContent value="login">
                <form onSubmit={loginForm.handleSubmit((data: LoginFormData) => loginMutation.mutate(data))}>
              ...
              <TabsContent value="register">
                <form onSubmit={registerForm.handleSubmit((data: RegisterFormData) => registerMutation.mutate(data))}>
                  <div className="space-y-4">
                    <div>
